...
const stripePromise = loadStripe('pk_test_51PF6Z7LmIkWljDh0sjvpRBw6c3GgGGP8IBD3j0KzNpynH8PeSqMM9o4cERVsSWMsEBLWvQdRb5JOysBNcsCRd12U00GAJG0bns');
  ...
  return (
    <div>
      ...
      <div>
        ...
        <button onClick={()=>handleClick(product.product_name, product.price*100)}>CheckOut</button>
      </div>
    </div>
  );
}
